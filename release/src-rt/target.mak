...
export RT-AC68U += BUILD_NAME="RT-AC68U" NEWSSID_REV2=y DBLOG=y ETHOBD=y DWB=y UUPLUGIN=y BTM_11V=y \
		...
		CFGSYNC_LOCSYNC=y AHS=n ASD=n FRS_LIVE_UPDATE=y OPEN_NAT=y CAPTCHA=y
...
export RT-AC86U += BUILD_NAME="RT-AC86U" NVSIZE="128" DHDAP=y DPSTA=y LACP=n WTFAST=n REPEATER=y \
				...
				HD_SPINDOWN=y NATNL_AIHOME=n ASPMD=n BCM_MEVENT=y BTM_11V=y BCN_RPT=y INFO_EXAP=y IPERF3=y \
				IPSEC=STRONGSWAN DFS_US=y ALEXA=n IFTTT=n DWB=y \
				CFGSYNC_LOCSYNC=y OPEN_NAT=n CAPTCHA=n UUPLUGIN=n AHS=n ASD=n FRS_LIVE_UPDATE=n \
...
export RT-AC88U_BASE := IPV6SUPP=y HTTPS=y ARM=y BCM57=y AUTODICT=y BBEXTRAS=y USBEXTRAS=y EBTABLES=y SAMBA3=3.6.x \
		...
		BCM_RECVFILE=y TFAT=y NTFS="tuxera" HFS="tuxera" CFEZ=y ERPTEST=n CLOUDCHECK=y UTF8_SSID=y \
		ASPMD=n BCMEVENTD=n WLCLMLOAD=n BCM_MUMIMO=y LAN50=y ATCOVER=y GETREALIP=y DWB=y \
...
export RT-AC88U += BUILD_NAME="RT-AC88U" RGMII_BRCM5301X=y SWITCH2="RTL8365MB" BCM_MMC=n BCM_7114=y \
		...
		NEWSSID_REV2=y DWB=y ASUSCTRL=y FRS_LIVE_UPDATE=y BW160M=y CFGSYNC_LOCSYNC=y AHS=n ASD=n \
		INTERNETCTRL=y OPEN_NAT=y UUPLUGIN=y CAPTCHA=y
...
export RT-AC3100 += BUILD_NAME="RT-AC3100" SWITCH2="" BCM_MMC=n BCM_7114=y ETLAN_LED=y ROMCFE=n \
		...
		BW160M=y AHS=n ASD=n INTERNETCTRL=y CAPTCHA=y
...
export RT-AC5300 += BUILD_NAME="RT-AC5300" RGMII_BRCM5301X=y SWITCH2="" BCM_MMC=n BCM_7114=y ETLAN_LED=y \
		NVSIZE="128" DHDAP=y DPSTA=y BCMFA=n GMAC3=y LACP=y WTFAST=y DWB=y \
		DISABLE_REPEATER_UI=y UUPLUGIN=y CFGSYNC_LOCSYNC=y FRS_LIVE_UPDATE=y BW160M=y AHS=n ASD=n \
		INTERNETCTRL=y CAPTCHA=y
