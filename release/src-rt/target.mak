...
#
export HND-94908_BASE := HND_ROUTER=y PROFILE="94908HND" SW_HW_AUTH=y AMAS=n UTF8_SSID=y ETHOBD=n DWB=y SAMBA3="3.6.x"
...
export RT-AC86U += BUILD_NAME="RT-AC86U" NVSIZE="128" DHDAP=y DPSTA=y LACP=n WTFAST=n REPEATER=y \
				...
				IPSEC=STRONGSWAN DFS_US=y ALEXA=n IFTTT=n DWB=n \
				BCMEVENTD=y BCM_APPEVENTD=y JFFS_NVRAM=y LETSENCRYPT=y UTF8_SSID=y AMAS=n DBLOG=y ETHOBD=n \
...
export RT-AC88U += BUILD_NAME="RT-AC88U" RGMII_BRCM5301X=y SWITCH2="RTL8365MB" BCM_MMC=n BCM_7114=y \
		...
		NEWSSID_REV2=y DWB=y ASUSCTRL=y FRS_LIVE_UPDATE=y
...
export RT-AC3100 += BUILD_NAME="RT-AC3100" SWITCH2="" BCM_MMC=n BCM_7114=y ETLAN_LED=y ROMCFE=n \
		...
		FORCE_SN="380" FORCE_EN="664" DISABLE_REPEATER_UI=n NEWSSID_REV2=y ASUSCTRL=y FRS_LIVE_UPDATE=y
...
export RT-AC5300 += BUILD_NAME="RT-AC5300" RGMII_BRCM5301X=y SWITCH2="" BCM_MMC=n BCM_7114=y ETLAN_LED=y \
		NVSIZE="128" DHDAP=y DPSTA=y BCMFA=n GMAC3=y LACP=y WTFAST=y DWB=y FORCE_SN="380" FORCE_EN="630" \
		DISABLE_REPEATER_UI=y UUPLUGIN=y
