...
export RT-AC56U := IPV6SUPP=y HTTPS=y ARM=y BCM57=y AUTODICT=y BBEXTRAS=y USBEXTRAS=y EBTABLES=y ROMCCODE=y \
		...
		DNSSEC=y NANO=y OPENSSL11=y NTPD=y
...
export RT-AC68U_BASE := IPV6SUPP=y HTTPS=y ARM=y BCM57=y AUTODICT=y BBEXTRAS=y USBEXTRAS=y EBTABLES=y \
			...
			TFAT=y HFS="tuxera" NTFS="tuxera" REPEATER=y DUALWAN=y DNSFILTER=y UPNPIGD2=n \
			DNSSEC=y NANO=y OPENSSL11=y NTPD=y DNSPRIVACY=y NETOOL=y TRACEROUTE=n

export RT-AC68U := $(RT-AC68U_BASE) FAKEHDR=y FORCE_SN=384 FORCE_EN=20000
export RT-AC68U += BUILD_NAME="RT-AC68U" NEWSSID_REV2=y LETSENCRYPT=y UTF8_SSID=y DBLOG=y ETHOBD=y DWB=y
...
export RT-AC87U := IPV6SUPP=y HTTPS=y ARM=y BCM57=y AUTODICT=y BBEXTRAS=y USBEXTRAS=y EBTABLES=y \
		...
		TFAT=y HFS="tuxera" NTFS="tuxera" REPEATER=y DUALWAN=y DNSFILTER=y UPNPIGD2=n \
		DNSSEC=y NANO=y OPENSSL11=y NTPD=y DNSPRIVACY=y


#
# Broadcom HND ARM platform
#
export HND-94908_BASE := HND_ROUTER=y PROFILE="94908HND" AMAS=n DWB=n ETHOBD=n SW_HW_AUTH=y UTF8_SSID=y
...
export RT-AC86U += BUILD_NAME="RT-AC86U" NVSIZE="128" DHDAP=y DPSTA=y LACP=n WTFAST=n REPEATER=y \
				...
				EBTABLES=y SAMBA3=3.6.x MEDIASRV=y MODEM=y PARENTAL2=y ACCEL_PPTPD=n PRINTER=y WEBDAV=y \
				...
				HD_SPINDOWN=y NATNL_AIHOME=n ASPMD=n BCM_MEVENT=y SW_HW_AUTH=y \
				...
				VISUALIZATION=y NFS=y DNSFILTER=y SNMPD=n TOR=n UPNPIGD2=n DNSSEC=y NANO=y OPENSSL11=y \
				NTPD=y DNSPRIVACY=y
...
export RT-AC3200 := IPV6SUPP=y HTTPS=y ARM=y BCM57=y AUTODICT=y BBEXTRAS=y USBEXTRAS=y EBTABLES=y SAMBA3=3.6.x \
		...
		NETOOL=y TRACEROUTE=n \
		NFS=y DNSFILTER=y SNMPD=y TOR=y UPNPIGD2=n DNSSEC=y NANO=y OPENSSL11=y NTPD=y DNSPRIVACY=y
...
export RT-AC88U_BASE := IPV6SUPP=y HTTPS=y ARM=y BCM57=y AUTODICT=y BBEXTRAS=y USBEXTRAS=y EBTABLES=y SAMBA3=3.6.x \
		...
		EMAIL=y ROG=y SSD=n STAINFO=y BCM5301X_TRAFFIC_MONITOR=y PROXYSTA=y AMAS=y \
