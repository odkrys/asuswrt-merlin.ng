...
#
export HND-94908_BASE := HND_ROUTER=y PROFILE="94908HND" AMAS=n DBLOG=y DWB=y ETHOBD=y SW_HW_AUTH=y UTF8_SSID=y
...
export RT-AC86U += BUILD_NAME="RT-AC86U" NVSIZE="128" DHDAP=y DPSTA=y LACP=n WTFAST=n REPEATER=y \
				...
				BCMEVENTD=y BCM_APPEVENTD=y JFFS_NVRAM=y LETSENCRYPT=y UTF8_SSID=y AMAS=n DBLOG=y ETHOBD=y \
